...
public abstract class Unpack15 extends BitInput {
	...
	protected int[] ChSet = new int[256], ChSetA = new int[256], ChSetB = new int[256],
			ChSetC = new int[256];

	protected int[] Place = new int[256], PlaceA = new int[256], PlaceB = new int[256],
			PlaceC = new int[256];
	...
	private static int DecL1[] = { 0x8000, 0xa000, 0xc000, 0xd000, 0xe000, 0xea00, 0xee00, 0xf000,
	...
	private static int DecL2[] = { 0xa000, 0xc000, 0xd000, 0xe000, 0xea00, 0xee00, 0xf000, 0xf200,
			0xf240, 0xffff };
	...
	private static int DecHf0[] = { 0x8000, 0xc000, 0xe000, 0xf200, 0xf200, 0xf200, 0xf200, 0xf200,
			0xffff };
	...
	private static int DecHf1[] = { 0x2000, 0xc000, 0xe000, 0xf000, 0xf200, 0xf200, 0xf7e0, 0xffff };

	private static int PosHf1[] = { 0, 0, 0, 0, 0, 0, 4, 44, 60, 76, 80, 80, 127 };

	private static final int STARTHF2 = 5;

	private static int DecHf2[] = { 0x1000, 0x2400, 0x8000, 0xc000, 0xfa00, 0xffff, 0xffff, 0xffff };
	...
	static int ShortXor1[] = { 0, 0xa0, 0xd0, 0xe0, 0xf0, 0xf8, 0xfc, 0xfe, 0xff, 0xc0, 0x80, 0x90,
			0x98, 0x9c, 0xb0 };

	static int ShortLen2[] = { 2, 3, 3, 3, 4, 4, 5, 6, 6, 4, 4, 5, 6, 6, 4, 0 };

	static int ShortXor2[] = { 0, 0x40, 0x60, 0xa0, 0xd0, 0xe0, 0xf0, 0xf8, 0xfc, 0xc0, 0x80, 0x90,
			0x98, 0x9c, 0xb0 };
	...
	protected boolean unpReadBuf() throws IOException, RarException {
		...
		// int
		// readCode=UnpIO->UnpRead(InBuf+DataSize,(BitInput::MAX_SIZE-DataSize)&~0xf);
