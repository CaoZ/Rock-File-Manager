...
public class PPMContext extends Pointer {
	...
	public final static int[] ExpEscape = { 25, 14, 9, 7, 5, 5, 4, 4, 4, 3, 3, 3, 2, 2, 2, 2 };
	...
	// public static void ppmdSwap(ModelPPM model, StatePtr state1, StatePtr
	// state2)
	// {
